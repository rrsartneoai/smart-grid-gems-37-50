...
Zaawansowana aplikacja do monitorowania i analizy zużycia energii, wyposażona w inteligentnego asystenta AI.
...
*   Przewidywanie trendów zużycia energii
*   Wykrywanie anomalii
...
*   **React + TypeScript:** Framework front-endowy
*   **Tanstack Query:** Zarządzanie danymi
*   **Shadcn/UI:** Komponenty interfejsu użytkownika
*   **Integracja z API Gemini:** Zaawansowane funkcje AI
...
*   Interaktywna pomoc AI

System wykorzystuje zaawansowane algorytmy AI do analizy danych i zapewnienia użytkownikom inteligentnego wsparcia w podejmowaniu decyzji dotyczących zarządzania energią.
```
